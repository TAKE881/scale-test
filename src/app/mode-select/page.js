  ...
  return (
    ...
    >
      <main className="flex flex-col items-center justify-center h-screen text-center">
        ...
        <p className="mb-7 text-2xl text-gray-600 font-bold text-stroke-sssm text-stroke-white">モードセレクト</p>
        ...
        <div className="flex flex-col gap-4">
          ...
          <Link href="/settings">
            <button
              className="
                relative px-6 py-0 text-base font-semibold text-stroke-sssssm text-stroke-white
            ...
            >設定
              <svg xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                className="ml-1 size-6 inline fill-gray-200">
